...
> **Taxonomy Reference**: §X.X Category Name (see reference/architecture_taxonomy_reference.md)
...
Use terminology from **[Architecture Taxonomy §11](reference/architecture_taxonomy_reference.md)** and consistent definitions:

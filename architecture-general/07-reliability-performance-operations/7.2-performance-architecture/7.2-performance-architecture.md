...
title: "2 Performance Architecture"
description: "Performance architecture focuses on optimizing response times, throughput, resource efficiency, and user experience. This document covers strategies, patterns, and practices for building high-perfo..."
...
- [Tail Latency and Distributed Systems Performance](./tail-latency-distributed-systems.md) - **Case study: When language change IS justified (Aurora DSQL)**
- [Language Transition Anti-Patterns](./language-transition-anti-patterns.md) - **Case study: When language change is NOT justified (Java to Go)**
...
- [Azure Load Balancing](../../architecture-azure/networking/15-load-balancing-services-comparison.md) - Azure load balancing services

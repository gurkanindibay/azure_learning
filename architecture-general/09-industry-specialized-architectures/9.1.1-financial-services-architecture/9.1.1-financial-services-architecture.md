...
title: "1.1 Financial Services Architecture"
description: "Financial Services Architecture encompasses the design patterns, security frameworks, and regulatory compliance structures required for banking, insurance, capital markets, and fintech applications..."
...
- [9.1.1.2 HSM in Payment Systems Architecture](./9.1.1.2-hsm-in-payment-systems-architecture.md) - HSM bottlenecks, pool isolation, and crypto-critical path design

...
```mermaid
gantt
    title Credit Card Settlement Timeline
    dateFormat  HH:mm
    axisFormat %H:%M
    
    section Day 0
    Transaction Occurs       :t1, 10:00, 1h
    Authorization            :t2, after t1, 5m
    Merchant Batch Close     :t3, 23:00, 30m
    
    section Day 1
    Clearing Files Sent      :t4, 02:00, 2h
    Network Processing       :t5, 04:00, 4h
    Interchange Calculation  :t6, 08:00, 2h
    
    section Day 2
    Settlement Complete      :t7, 06:00, 2h
    Merchant Funding         :t8, 10:00, 4h
```

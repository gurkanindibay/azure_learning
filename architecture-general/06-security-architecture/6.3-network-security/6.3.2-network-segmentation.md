...
title: "3.2 Network Segmentation"
description: "Network segmentation is the practice of dividing a network into smaller, isolated sub-networks (segments) to improve security, performance, and manageability. By controlling traffic between segment..."
...
- [6.3 Network Security Architecture](./index.md) — Parent topic

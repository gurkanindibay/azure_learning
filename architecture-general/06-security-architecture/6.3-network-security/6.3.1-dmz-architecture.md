...
title: "3.1 Demilitarized Zone (DMZ) Architecture"
description: "A Demilitarized Zone (DMZ) is a network security architecture that creates an isolated network segment between an organization's internal trusted network and the external untrusted network (typical..."
...
- [6.1 Security Architecture](../6.1-security-foundations/) - Zero Trust principles
- [6.2 Identity Architecture](../6.2-identity/) - Authentication and authorization
- [6.4 Data Security Architecture](../6.4-data-security/) - Data protection in transit
...
- [Multi-Cloud Networking](../../05-cloud-infrastructure-platform-architecture/) - Hybrid DMZ architectures

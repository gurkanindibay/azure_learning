...
- ⚠️ **NSGs do not support FQDN-based rules** — if you need to allow/block traffic based on domain names (e.g., allow only `www.udemy.com`), use [Azure Firewall](firewall/azure-firewall-overview.md) which supports FQDN filtering in application and network rules

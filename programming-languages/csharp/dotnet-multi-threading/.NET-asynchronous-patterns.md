...
title: ".NET Asynchronous Programming Patterns & Thread Optimization"
description: ".NET has evolved through three major asynchronous programming models:"
tags: [csharp, dotnet]
...
## Table of Contents
  ...
  - [**Pros**](#pros-3)
  - [**5.1 When async/await Is Not Ideal**](#51-when-asyncawait-is-not-ideal)
  - [**5.2 Examples**](#52-examples)
    - [❌ Avoid unnecessary async/await:](#avoid-unnecessary-asyncawait)
    - [✔️ Use async/await only when additional logic exists:](#use-asyncawait-only-when-additional-logic-exists)
  - [**6.1 CPU-bound**](#61-cpu-bound)
  - [**6.2 I/O-bound**](#62-io-bound)
- [**7.1 Theoretical Formula (Little’s Law Inspired)**](#71-theoretical-formula-littles-law-inspired)
  - [**Example**](#example-2)
- [**7.2 Empirical Approach**](#72-empirical-approach)
- [**7.3 Modern Recommendation**](#73-modern-recommendation)
  - [**When You Can Skip async/await**](#when-you-can-skip-asyncawait)
  - [**Patterns**](#patterns)
  - [**When NOT to use async/await**](#when-not-to-use-asyncawait)
  - [**Threading**](#threading)

...
| 3 | [`java-jvm.md`](java-jvm.md) | Java JVM & Memory Management | JVM Heap Memory, Young Generation, Old Generation, Stack Memory, Metaspace, Garbage Collection, GC Pause, G1GC, ZGC, OutOfMemoryError, Memory Leak, ThreadLocal, Heap Dump, Virtual Threads, Thread Pinning, Carrier Thread, CallerRunsPolicy, HashMap, Treeification |
...
| 5 | [`networking.md`](networking.md) | Networking | Anycast, BGP, PoP, Hub-and-Spoke, DMZ, CDN, Service Mesh, Load Balancer, API Gateway, Consistent Hashing, Nagle's Algorithm / TCP_NODELAY, Zero-Copy Transfer, Network Partition |
...
| 16 | [`concurrency-runtimes.md`](concurrency-runtimes.md) | Concurrency Models & Language Runtimes | GOMAXPROCS, Goroutine, M:N Scheduling, Tokio, Event Loop, Context Switching, Amdahl's Law, Actor Model, I/O-bound vs CPU-bound, Race Condition, Thread Pool Sizing Formula |

...
| 10 | [`ai-ml-llm.md`](ai-ml-llm.md) | AI/ML, LLM & Agentic AI | LLM, RAG, Vector DB, Embedding, Grounding, Hallucination, Agentic AI, Tool Calling, MCP, Five Levels, Dark Factory, Structure-Aware Chunking, Semantic Chunking, Chunk Inspection Audit, KB-Gap Detector, Grounding Rate, Reopen-Gated Auto-Resolution Rate, Model Routing by Complexity, Graceful Spend Degradation, Copilot Acceptance Rate, Generative Watermarking, Content Credentials (C2PA), G-Value, Disposable Repositories |

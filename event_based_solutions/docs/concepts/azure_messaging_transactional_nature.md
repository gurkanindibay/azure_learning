...
- [Overview](#overview)
- [1. Azure Service Bus - Strong Transactional Support](#1-azure-service-bus-strong-transactional-support)
  - [1.1 Sending (Publishing) Transactions](#11-sending-publishing-transactions)
    - [✅ Full Transaction Support](#full-transaction-support)
    - [Transaction Capabilities:](#transaction-capabilities)
    - [Guarantees:](#guarantees)
  - [1.2 Receiving (Consuming) Transactions](#12-receiving-consuming-transactions)
    - [✅ Peek-Lock Pattern (Default)](#peek-lock-pattern-default)
...
- [2. Azure Event Hubs - Limited Transactional Support](#2-azure-event-hubs-limited-transactional-support)
  - [2.1 Sending (Publishing) Transactions](#21-sending-publishing-transactions)
    - [⚠️ Batch-Level Atomicity Only](#batch-level-atomicity-only)
    - [Transaction Capabilities:](#transaction-capabilities-3)
    - [Guarantees:](#guarantees-3)
  - [2.2 Receiving (Consuming) Transactions](#22-receiving-consuming-transactions)
    - [❌ No Built-in Transaction Support](#no-built-in-transaction-support)
    - [Characteristics:](#characteristics-2)
    - [Checkpoint-Based Processing:](#checkpoint-based-processing)
    - [Guarantees:](#guarantees-4)
  - [2.3 Comparison: Event Hubs vs Service Bus](#23-comparison-event-hubs-vs-service-bus)
- [3. Azure Event Grid - No Transaction Support](#3-azure-event-grid-no-transaction-support)
  - [3.1 Sending (Publishing) Transactions](#31-sending-publishing-transactions)
    - [❌ No Transaction Support](#no-transaction-support)
    - [Characteristics:](#characteristics-3)
    - [Publishing Guarantees:](#publishing-guarantees)
  - [3.2 Receiving (Consuming) Transactions](#32-receiving-consuming-transactions)
    - [❌ No Transaction Support (Push Model)](#no-transaction-support-push-model)
    - [Characteristics:](#characteristics-4)
    - [Delivery Behavior:](#delivery-behavior)
    - [Delivery Guarantees:](#delivery-guarantees)
- [4. Transaction Support Comparison Matrix](#4-transaction-support-comparison-matrix)
  - [4.1 Sending (Publishing) Transactions](#41-sending-publishing-transactions)
  - [4.2 Receiving (Consuming) Transactions](#42-receiving-consuming-transactions)
- [5. Transactional Patterns and Best Practices](#5-transactional-patterns-and-best-practices)
  - [5.1 Service Bus Transactional Patterns](#51-service-bus-transactional-patterns)
    - [Pattern 1: Request-Response with Transaction](#pattern-1-request-response-with-transaction)
    - [Pattern 2: Aggregate Processing](#pattern-2-aggregate-processing)
    - [Pattern 3: Saga Pattern with Compensation](#pattern-3-saga-pattern-with-compensation)
  - [5.2 Event Hubs Patterns (Compensating for Lack of Transactions)](#52-event-hubs-patterns-compensating-for-lack-of-transactions)
    - [Pattern 1: Checkpoint After Success](#pattern-1-checkpoint-after-success)
    - [Pattern 2: Idempotent Processing with Deduplication](#pattern-2-idempotent-processing-with-deduplication)
    - [Pattern 3: Manual Dead-Letter to Blob Storage](#pattern-3-manual-dead-letter-to-blob-storage)
  - [5.3 Event Grid Patterns (Compensating for Lack of Transactions)](#53-event-grid-patterns-compensating-for-lack-of-transactions)
    - [Pattern 1: Idempotent Webhook Handler](#pattern-1-idempotent-webhook-handler)
    - [Pattern 2: Two-Phase Processing](#pattern-2-two-phase-processing)
    - [Pattern 3: Event Grid + Service Bus Hybrid](#pattern-3-event-grid-service-bus-hybrid)
- [6. Decision Matrix: When to Use Each Service](#6-decision-matrix-when-to-use-each-service)
  - [6.1 Use Service Bus When:](#61-use-service-bus-when)
  - [6.2 Use Event Hubs When:](#62-use-event-hubs-when)
  - [6.3 Use Event Grid When:](#63-use-event-grid-when)
- [7. Summary Table](#7-summary-table)
- [8. Code Examples: Complete Scenarios](#8-code-examples-complete-scenarios)
  - [8.1 Service Bus: E-Commerce Order Processing (Transactional)](#81-service-bus-e-commerce-order-processing-transactional)
  - [8.2 Event Hubs: Telemetry Processing (Idempotent Pattern)](#82-event-hubs-telemetry-processing-idempotent-pattern)
  - [8.3 Event Grid: Webhook Handler (Idempotent + Durable)](#83-event-grid-webhook-handler-idempotent-durable)
- [9. Key Takeaways](#9-key-takeaways)
  - [Service Bus: The Transactional Champion](#service-bus-the-transactional-champion)
  - [Event Hubs: The Streaming Specialist](#event-hubs-the-streaming-specialist)
  - [Event Grid: The Event Distributor](#event-grid-the-event-distributor)

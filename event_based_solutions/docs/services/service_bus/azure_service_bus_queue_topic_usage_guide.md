...
- [2. Detailed Usage Patterns](#2-detailed-usage-patterns)
  - [2.1 When to Use Queues](#21-when-to-use-queues)
    - [✅ **Perfect for Queues:**](#perfect-for-queues)
    - [❌ **Avoid Queues When:**](#avoid-queues-when)
  - [2.2 When to Use Topics](#22-when-to-use-topics)
    - [✅ **Perfect for Topics:**](#perfect-for-topics)
    - [❌ **Avoid Topics When:**](#avoid-topics-when)
- [3. Architecture Patterns](#3-architecture-patterns)
  - [3.1 Queue Patterns](#31-queue-patterns)
    - [**Pattern 1: Simple Work Queue**](#pattern-1-simple-work-queue)
    - [**Pattern 2: Chain of Queues**](#pattern-2-chain-of-queues)
  - [3.2 Topic Patterns](#32-topic-patterns)
    - [**Pattern 1: Event Fan-out**](#pattern-1-event-fan-out)
    - [**Pattern 2: Content-Based Routing**](#pattern-2-content-based-routing)
    - [**Pattern 3: Workflow Orchestration**](#pattern-3-workflow-orchestration)
- [4. Performance Considerations](#4-performance-considerations)
  - [4.1 Queue Performance](#41-queue-performance)
  - [4.2 Topic Performance](#42-topic-performance)
- [5. Real-World Scenarios](#5-real-world-scenarios)
  - [5.1 E-commerce Platform](#51-e-commerce-platform)
    - [**Scenario A: Order Processing (Use Queue)**](#scenario-a-order-processing-use-queue)
    - [**Scenario B: Order Events (Use Topic)**](#scenario-b-order-events-use-topic)
  - [5.2 IoT Data Processing](#52-iot-data-processing)
    - [**Scenario A: Telemetry Processing (Use Queue)**](#scenario-a-telemetry-processing-use-queue)
    - [**Scenario B: Alert Processing (Use Topic)**](#scenario-b-alert-processing-use-topic)
  - [5.3 Document Management System](#53-document-management-system)
    - [**Scenario A: Document Processing (Use Queue)**](#scenario-a-document-processing-use-queue)
    - [**Scenario B: Document Events (Use Topic)**](#scenario-b-document-events-use-topic)
- [6. Migration and Hybrid Patterns](#6-migration-and-hybrid-patterns)
  - [6.1 Queue to Topic Migration](#61-queue-to-topic-migration)
  - [6.2 Hybrid Patterns](#62-hybrid-patterns)
    - [**Pattern 1: Queue → Topic Chain**](#pattern-1-queue-topic-chain)
    - [**Pattern 2: Topic → Queue Fan-out**](#pattern-2-topic-queue-fan-out)
- [7. Best Practices Summary](#7-best-practices-summary)
  - [7.1 Choose Queue When:](#71-choose-queue-when)
  - [7.2 Choose Topic When:](#72-choose-topic-when)
  - [7.3 Common Anti-patterns:](#73-common-anti-patterns)
  - [7.4 Decision Checklist:](#74-decision-checklist)
- [8. Code Examples](#8-code-examples)
  - [8.1 Queue Implementation](#81-queue-implementation)
  - [8.2 Topic Implementation](#82-topic-implementation)
  - [8.3 Subscription Filters](#83-subscription-filters)
- [9. Monitoring and Observability](#9-monitoring-and-observability)
  - [9.1 Queue Metrics](#91-queue-metrics)
  - [9.2 Topic Metrics](#92-topic-metrics)
  - [9.3 Key Alerts](#93-key-alerts)

...
> **Azure**: [Azure SQL indexes](../../architecture-azure/data/databases/) | **General**: §2.2 Query Optimization | **Related**: [db-03: Composite Index vs. Separate Indexes](01-databases-query-performance.md#db-03-composite-index-vs-separate-indexes)
...
> **Related**: [db-04: N+1 Query Problem](01-databases-query-performance.md#db-04-n1-query-problem)

...
> **Also see**: [Resilience Patterns](10-resilience-patterns.md), [Architecture Principles](40-arch-key-takeaways.md), [Design Patterns](39-design-patterns-key-takeaways.md)
...
> **Also see**: [Strangler Fig](../reference-dictionary/architecture-patterns.md#strangler-fig) · [Anti-Corruption Layer](../reference-dictionary/architecture-patterns.md#anti-corruption-layer) · [dp-10: Leaky Data Access](39-design-patterns-key-takeaways.md#dp-10-leaky-data-access-in-domain-logic) · [arch-02: Separation of Concerns](40-arch-key-takeaways.md#arch-02-separation-of-concerns)

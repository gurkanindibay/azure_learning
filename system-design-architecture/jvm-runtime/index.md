...
| [65-jvm-key-takeaways.md](65-jvm-key-takeaways.md) | `jvm-20` – `jvm-26` | Constructor injection, Validated configuration properties, AOP proxy self-invocation boundaries, RestClient, RFC 7807 ProblemDetail, JPA N+1 elimination, Virtual threads |

...
|:---|:---|:---|
| [api-network-design.md](api-network-design.md) | `api-01` – `api-12` | Versioning, Rate limiting, Large uploads, Async tasks, Consistent hash routing, API deprecation, Multi-tenant limits |

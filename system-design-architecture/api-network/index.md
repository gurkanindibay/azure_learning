...
| [api-gateway-bottlenecks-takeaways.md](api-gateway-bottlenecks-takeaways.md) | `gw-07` – `gw-12` | Gateway scaling, Auth offloading, Connection pooling, HTTP/2 multiplexing, Async logging, Hybrid token bucket rate limiting, Edge caching & request coalescing, Observability golden signals |
